...
@section('content')
    ...
    <div class="col-md-7 col-md-offset-1">
        <form action="{{route("createRicePurchaseInvoice")}}" method="post" id="form">
        ...
        <button type="submit" class="btn btn-primary" onclick="document.getElementById('form').style.display='none'">Create Invoice</button>
    </div>
