    ...
    <div class="col-md-7 col-md-offset-1">
        <form action="{{route("createRiceOrderReceipt")}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="supplierName" name="supplierName" value="{{$orderDetails[0]}}" readonly>
            </div>
        ...
        <?php
            ...
            <div class="form-inline">
                <div class="form-group">
                    <label for="orderItem{{$i}}">Purchase Item</label>
                    <input type="text" class="form-control" id="orderItem{{$i}}" name="orderItem{{$i}}" value="{{$orderDetails[$i]}}" readonly>
                </div>
                <div class="form-group">
                    <label for="quantity{{$i}}">Quantity</label>
                    <input type="number" class="form-control" id="quantity{{$i}}" name="quantity{{$i}}" value="{{$orderDetails[$i+1]}}" readonly>
                </div>
                <div class="form-group">
                    <label for="unitPrice{{$i}}">Unit Price</label>
                    <input type="number" class="form-control" id="unitPrice{{$i}}" name="unitPrice{{$i}}" value="{{$orderDetails[$i+2]}}" readonly>
                </div>
